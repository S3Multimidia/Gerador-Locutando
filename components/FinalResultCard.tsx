  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <a href={isEncoding ? undefined : downloadUrl} download="locucao_turbo.mp3" onClick={(e) => (isEncoding || !downloadUrl) && e.preventDefault()} className={`w-full flex items-center justify-center p-3 bg-gray-700 text-white font-bold rounded-lg shadow-md hover:bg-gray-800 transition-all transform hover:scale-105 focus-ring ${isEncoding || !downloadUrl ? 'opacity-50 cursor-not-allowed' : ''}`} aria-disabled={isEncoding || !downloadUrl}>
          {isEncoding ? (
         ...
         <button onClick={onDiscard} className="w-full flex items-center justify-center p-3 bg-white text-gray-700 font-bold rounded-lg shadow-md hover:bg-gray-100 border border-gray-300 transition-all transform hover:scale-105 focus-ring" aria-label="Descartar">
